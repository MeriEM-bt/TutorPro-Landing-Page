...
- Added new [WPNCEasyWP-Cron-Boilerplate](https://github.com/wpbones/WPNCEasyWP-Cron-Boilerplate) example plugin
- Added new [WPNCEasyWP-Hooks-Boilerplate](https://github.com/wpbones/WPNCEasyWP-Hooks-Boilerplate) example plugin
...
- Added new [WPNCEasyWP-Database-Boilerplate](https://github.com/wpbones/WPNCEasyWP-Database-Boilerplate) example plugin.
...
- Updated and improved the [WPNCEasyWP Demo](https://github.com/wpbones/WPNCEasyWP) plugin.
...
- Added new [WP Bones API Boilerplate](https://github.com/wpbones/WPNCEasyWP-API-Boilerplate) example plugin.
- Added new [WP Bones Internationalization Boilerplate](https://github.com/wpbones/WPNCEasyWP-Internationalization-Boilerplate) example plugin.
- Added new [WP Bones Mantine Boilerplate](https://github.com/wpbones/WPNCEasyWP-Mantine-Boilerplate) example plugin.
- Added new [WP Bones ReactJS Boilerplate](https://github.com/wpbones/WPNCEasyWP-ReactJS-Boilerplate) example plugin.
- Added new [WP Bones Routes Boilerplate](https://github.com/wpbones/WPNCEasyWP-Routes-Boilerplate) example plugin.
...
- Updated the [WPBones demo plugin](https://github.com/wpbones/WPNCEasyWP).
- Updated the [WPBones Boilerplate plugin](https://github.com/wpbones/WPNCEasyWP-Boilerplate)
...
- In the [WPBones demo plugin](https://github.com/wpbones/WPNCEasyWP) and [WPBones Boilerplate plugin](https://github.com/wpbones/WPNCEasyWP-Boilerplate) we have renamed the `localization` folder to `languages`.
