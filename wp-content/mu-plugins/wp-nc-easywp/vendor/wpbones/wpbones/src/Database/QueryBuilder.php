...
use WPNCEasyWP\WPBones\Database\Support\Collection;
use WPNCEasyWP\WPBones\Database\Support\Model;
...
class QueryBuilder
{
   ...
   *
   * @var \WPNCEasyWP\WPBones\Database\Support\Collection
   */
  private $collection = [];
  ...
  */
   ...
   * @return \WPNCEasyWP\WPBones\Database\QueryBuilder
   */
