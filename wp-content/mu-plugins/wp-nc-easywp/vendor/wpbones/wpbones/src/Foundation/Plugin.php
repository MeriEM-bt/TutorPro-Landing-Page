...
use Closure;
use WPNCEasyWP\WPBones\Container\Container;
use WPNCEasyWP\WPBones\Contracts\Foundation\Plugin as PluginContract;
use WPNCEasyWP\WPBones\Database\WordPressOption;
use WPNCEasyWP\WPBones\Foundation\Http\Request;
use WPNCEasyWP\WPBones\Foundation\Log\LogServiceProvider;
use WPNCEasyWP\WPBones\Routing\AdminMenuProvider;
use WPNCEasyWP\WPBones\Routing\AdminRouteProvider;
use WPNCEasyWP\WPBones\Routing\API\RestProvider;
use WPNCEasyWP\WPBones\Routing\Pages\PageProvider;
use WPNCEasyWP\WPBones\Support\Str;
use WPNCEasyWP\WPBones\Support\Traits\HasAttributes;
use WPNCEasyWP\WPBones\View\View;
use WPNCEasyWP\WPBones\Database\Eloquent;
...
class Plugin extends Container implements PluginContract
{
  ...
  {
    // simulate __FILE__
    $this->file = $this->basePath . '/wpnceasywp.php';
  ...
  private function initPluginData()
  {
     ...
     * Description = "WPNCEasyWP is a WP Bones boilerplate plugin"
     * DomainPath = "languages"
     * Name = "WPNCEasyWP"
     * Network = false
     * PluginURI = "https://wpbones.com/"
     * TextDomain = "wpnceasywp"
     * Title = "WPNCEasyWP"
     * Version = "1.0.0"
     */
  ...
  public function getCallableHook($routes)
  {
    ...
    if (isset($controller) && isset($method)) {
      return function () use ($controller, $method) {
        $className = "WPNCEasyWP\\Http\\Controllers\\{$controller}";
